...
const DEFAULT_SITE_URL = 'https://rajasthali-website.onrender.com';
...
function businessSchema() {
  return {
    ...
    description: "IATA-certified, Government of India approved premier transport and travel company established 2010. Headquartered in Jaipur with pan-India operations. Trusted by Fortune 500 corporates, international tourists, NRI families, and destination weddings globally. Services: corporate travel nationwide, luxury wedding transport across India, MICE events, airport transfers all major cities, coach rentals, and curated tour packages — Rajasthan heritage circuits, Golden Triangle Delhi-Agra-Jaipur, Char Dham Yatra, Kerala backwaters, Goa beaches, Himalayas, Kashmir, Northeast India, and international outbound tours.",
    foundingDate: '2010',
    ...
    paymentAccepted: 'Cash, Credit Card, Debit Card, UPI, Bank Transfer, International Wire Transfer',
    areaServed: [
